...
Me: Yeah, I mean, but they're just like terrible. You know, like 9, 8% Direct pay. Like, just ridiculous. They're aware that they're up for termination, you know? So they're asking me, like, "What's going on? Like, am I losing my job or not or what?" And I'm like, honestly, like, I don't even have a clear answer for you right now because it's just under review, you know? So like, they're waiting to see, you know — I'm waiting to see. And it's just like a hot mess, dude.`,
  ...
  },
  {
    ...
    linkedEventIds: ["e-2025-07-14-jen-allan-waitlist"],
    reliability: "confirmed-screenshot",
  ...
  },
  {
    ...
    linkedEventIds: ["e-2025-07-03-waitlist-harbin-absent"],
    reliability: "confirmed-screenshot",
  ...
  },
  {
    ...
    linkedEventIds: ["e-2025-01-22-waitlist-harbin-row-6"],
    reliability: "confirmed-screenshot",
...
7. Harbin closed by stating she will pursue legal resources.`,
  ...
  },
  {
    ...
    peopleIds: ["harbin", "allan"],
    summary:
      "2024 Year-End Review. Manager: Allan Glover (26841). Evaluated By: Allan Glover (26841). Organization: Field CAR. Location: Home – US – AZ.\n\nOVERALL — Manager rating: SOLID; Employee self-rating: OUTSTANDING. Acknowledged by Shawnna Harbin (3591E) on 01/08/2025.\n\nSUB-GOAL RATINGS (Manager / Employee):\n• Required Risk Goal — SOLID / STRONG. Uniformly positive narrative: training completed timely without DM oversight, proactive risk assessment, leverage of iSuggest, influencing standards, creating a safe escalation environment.\n• Required DE&I Goal — STRONG / OUTSTANDING. Manager explicitly praises Harbin for 'displaying the confidence to speak up and challenge the status quo' and 'pushing us on potential blind spots' — language directly inconsistent with treating her complaints as a performance issue.\n• Build A Culture That Creates Engaged Employees — STRONG / OUTSTANDING.\n• Create Efficiencies and Control Costs — STRONG / STRONG.\n• Drive Effective Team Performance — STRONG / OUTSTANDING.\n• People Leadership section summary — STRONG / OUTSTANDING. Manager notes Goal one average 3.75 with 4.00+ in 8 of 12 months; Goal two 2.90 (myVoice 3.88 vs. Employee First 2.36); Goal three 2.62.\n\nDISCOVER BEHAVIORS (Manager / Employee):\n• We Play to Win — STRONG / OUTSTANDING. The added screenshots show specific manager praise under the behaviors rubric while still tying some bullets to 'Risk Related.'\n• We Get Better Every Day (Curious / Innovate & Simplify / Develop Ourselves) — SOLID / OUTSTANDING. Added pages show manager ratings of Solid on these behavior clusters while Harbin self-rated Outstanding.\n• We Succeed Together (Good Partners / Positive Energy / Develop Others) — SOLID / OUTSTANDING. Added pages show 'Develop Others' separately marked SOLID by the manager and OUTSTANDING by Harbin. Manager comment explicitly praises Harbin: 'Shawnna has leveraged the power of being assertive, because it has opened the door to accepting and understanding the opinions of those around her,' and notes 'multiple Bravo recognition received by peers for her commitment to teamwork and providing value.'\n• Development — Added screenshot shows Allan's written response that Harbin developed team-leader administrative and leadership skills, adapted to the organization, and fostered stronger peer relationships.\n\nKEY EVIDENTIARY POINT: Every individual sub-goal received SOLID or STRONG from the manager and every Discover Behavior received SOLID or STRONG, yet the OVERALL rating was downgraded to SOLID — a step down from the FY2023 STRONG rating (EX-050, EX-052, under a different manager). No sub-goal and no behavior supports the downgrade; bonus payout (EX-051) was 124.36% of target; manager comments include 'courage to make problems visible' and 'multiple Bravo recognition.' The downgrade landed in the first review cycle after Harbin's May 7, 2024 EEOC charge and May 29, 2024 formal complaint naming Carfagna and others. Pairs with EX-049 in which Allan Glover, unprompted, repeatedly told HR Harbin is 'the best team lead he's got.'",
