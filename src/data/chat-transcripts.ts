...
export const chatThreads: ChatThread[] = [
  {
    ...
    significance:
      "Two compounding red flags. (1) Direct misrepresentation: on the date of this chat the controlling 'Current TL Shifts' SharePoint waitlist (EX-044, last saved July 3, 2025 and unchanged through July 16) did NOT contain Harbin — yet Jen hands Allan a 5-row snippet that includes her, and Allan forwards it as confirmation. (2) ≈60-second turnaround: Allan's 8:51 AM question and Jen's 8:52 AM reply-with-screenshot leave no time to open the live waitlist, locate Harbin (who is not on it), crop out the four material processing columns (Date Requested, Months as CAR TL, Temporary/Permanent, Qualifies), take a screenshot, and send — consistent with a pre-prepared sanitized view already on screen, not a fresh pull. Harbin was not actually added to the live waitlist until Edina Markus re-added her on July 16 with a backdated 'Date Requested' of July 17, 2025 — a date that post-dates this very conversation.",
    messages: [
      {
