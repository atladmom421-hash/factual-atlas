...
export const chatThreads: ChatThread[] = [
  {
    ...
    significance:
      "Contemporaneous in-writing acknowledgment by both the Department Manager and the Business Manager that Harbin was on the pending shift-change list — yet the official SharePoint waitlist 11 days earlier (EX-044, July 3 snapshot) did not include her, and the list Jen sent omits the material 'Date Requested,' 'Months as CAR TL,' 'Temp/Perm,' and 'Qualifies' columns that the real waitlist tracks.",
    messages: [
      {
