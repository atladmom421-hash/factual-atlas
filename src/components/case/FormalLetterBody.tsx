    ...
    <div className="mx-auto max-w-3xl px-6 py-10 sm:py-14">
      ...
      <article className="rounded-md border border-border bg-card px-8 py-10 font-serif text-[14px] leading-[1.7] text-foreground/90 sm:px-12 sm:py-14 print:border-0 print:px-0 print:py-0 print:shadow-none">
        ...
        <p className="mt-3">
          ...
          <em>Oncale v. Sundowner Offshore Servs., Inc.</em>, 523 U.S. 75 (1998), and{" "}
        ...
        <p className="mt-3"><strong>Respondent argues that I cannot establish race discrimination because I supposedly did not suffer a materially adverse employment action.</strong> The record shows otherwise. I was kept on PM/closing for an extended period despite repeated requests to return to mid-shift or move to an earlier schedule — a schedule that affected my family obligations, childcare, internal mobility, and access to development opportunities. I was removed from the waitlist, shown an incomplete screenshot that did not match the controlling SharePoint file, re-added with a later request date, and converted from PM/Temporary to PM/Permanent with no ticket, notice, or approval documentation.</p>
        <p className="mt-3"><strong>Continued employment and pay do not defeat the claim.</strong> Under Title VII, schedule, assignments, opportunity, visibility, and working conditions can be terms or conditions of employment. The record shows harm to my schedule, advancement path, project access, performance rating, and career mobility.</p>
        <p className="mt-3"><strong>Respondent states that I received strong evaluations.</strong> The record shows a Strong → Solid → Strong pattern: 2023 Strong, 2024 Solid in the first review cycle after my May 2024 EEOC charge and May 29, 2024 internal complaint (despite no goal rated below Solid and a 124.36% bonus payout), 2025 back to Strong. Leadership later confirmed that a 4 Strong or 5 Outstanding was required for the TL Plus / Department Manager training cohort, so the 2024 Solid rating excluded me from that pipeline.</p>
        <p className="mt-3"><strong>Respondent claims I failed to identify similarly situated comparators outside my protected class.</strong> Tyler Millisock — same April 3, 2023 start date, same level, outside my protected class — moved from LVAR PM/closing to PRE-D/DBC 11:30 a.m.–8:00 p.m. while I remained on PM/closing, and stated he was not on the waitlist. That contradicts Respondent's position that movement was strictly controlled by a centralized waitlist.</p>
        <p className="mt-3"><strong>The waitlist records show inconsistent treatment.</strong> I requested mid-shift in 2024, discovered on April 26, 2024 that I was not on the MID waitlist, and raised that in my May 29, 2024 complaint and May 31, 2024 HR intake call. Respondent's own January 22, 2025 snapshot showed me on the list with a June 26, 2024 request date, PM/Temporary status, and Qualifies = Yes. By February 25, 2025, after multiple Jen Roy edits, my row was removed while others remained. No ticket has been produced and no authorization has been identified.</p>
        <p className="mt-3"><strong>Respondent's "May 2025 offer/decline" explanation is contradicted by the record.</strong> No offer, decline, ticket, communication, shift detail, or recording-person has been produced. The removal predates the alleged offer by roughly three months (see also Sections II.O and III.E.1).</p>
        <p className="mt-3"><strong>Respondent's account of the July 10, 2025 "reentry" is misleading.</strong> The mid-shift request originated in 2024, not July 2025. In June 2025 I asked to be considered for AM in addition to the mid-shift request I believed was pending. In July, I asked Allan Glover where I was on the waitlist; he contacted Jen Roy, who within roughly one minute produced a five-row screenshot omitting Date Requested, Months as CAR TL, Temp/Perm status, and Qualifies. The controlling SharePoint waitlist did not contain my name at that time. I was later re-added with a July 17, 2025 request date, resetting the June 26, 2024 date shown in the January 2025 snapshot.</p>
        <p className="mt-3"><strong>Respondent says managers did not control the process.</strong> On the September 19, 2025 recorded conversation, Allan stated there "wasn't a criteria" for Training Bay movement and identified the decisionmakers as "myself, Amber, Trevor, Dan." That is discretionary, not centralized and automatic.</p>
        <p className="mt-3"><strong>Respondent attributes schedule differences to separate roles, preexisting assignments, training, or accommodations.</strong> That explanation is unsupported without the underlying records. Respondent should produce the comparator movement records, tickets, accommodations, training assignments, onboarding records, and schedules for every employee it claims is distinguishable.</p>
        <p className="mt-3"><strong>Respondent's advancement argument is incomplete.</strong> I applied for nearly 50 internal roles between approximately February 2023 and April 2025. Respondent has not produced postings, selected candidates, interview notes, scoring criteria, recruiter notes, decisionmaker names, or comparative qualifications. A conclusory "more qualified" label cannot rebut discrimination without those records and without evidence of decisionmaker knowledge of my protected activity.</p>
        <p className="mt-3"><strong>Respondent ignores project exclusion.</strong> Advancement at Discover also runs through project visibility, operational tools, process-improvement work, and leadership sponsorship. After my protected activity I was excluded from project-related opportunities and credit, including the use or recreation of my Compliance Check concept by Cyndy Smith's group and the absence of meaningful support for the call-flow/process tools I attempted to present to Greg Carfagna.</p>
        <p className="mt-3"><strong>Respondent's "same protected class" argument as to Mr. Glover does not defeat the claim.</strong> The decisions at issue also involve Rosanna Blackson, Greg Carfagna, Jen Roy, Edina Markus, Amber, Trevor, Dan, HR, Employee Relations, and scheduling administrators. The law does not presume a person cannot discriminate against someone who shares a protected trait, and that argument does not erase the comparator evidence, timing, inconsistent records, race-related comments, or unequal process.</p>
        <p className="mt-3"><strong>Respondent dismisses the hardship-fund and HBCU comments as isolated.</strong> They are not. Shortly before the July 10, 2025 incident, I assisted Brandi Cordi, a White team member, with a hardship-fund request; she was not required to submit supporting documentation, only to identify the need. Allan was aware and raised no concern. Shortly after, when I asked about helping Araksan Dide, a Black employee who was homeless, Allan told me to hold off and offered an "example" that if one Black employee told another Black employee and that person tried to access the hardship fund it "could be a serious problem." A same-day text (<Ex id="EX-064" />) memorialized in real time my perception that Allan "was insinuating that I was only helping Black people" and his response that "that's a problem." Allan later told me he was "just providing an example of what could happen." That is race entering a benefits discussion, not isolated banter.</p>
        <p className="mt-3"><strong>The HBCU and "blockade" comments are tied to opportunity.</strong> Allan raised HBCU recruiting and the "blockade" framing during a broader conversation about blocked advancement, lack of projects, and schedule restrictions. That he had no formal recruiting title does not answer whether the statements were made or whether HBCU recruiting produced hires.</p>
        <p className="mt-3">The record supports an inference of discrimination: comparator movement while I remained fixed; inconsistent waitlist records and a missing ticket; an unsupported May 2025 offer/decline explanation contradicted by a February 2025 removal; a 2024 rating downgrade after protected activity that excluded me from the Department Manager pipeline; ~50 unsuccessful internal applications without produced selection records; project exclusion; disparate hardship-fund treatment with contemporaneous documentation; and race-tied "blockade" and HBCU comments. At minimum, these create material factual disputes requiring investigation and production of the underlying records.</p>
        ...
        <p className="mt-3"><strong>Respondent does not dispute that I engaged in protected activity.</strong> I filed an EEOC charge in May 2024 and made multiple internal complaints regarding race discrimination, retaliation, schedule equity, project exclusion, and related workplace concerns. Respondent's position is that no materially adverse action occurred and that there is no causation. The record does not support that argument.</p>
        <p className="mt-3">Respondent's argument depends on an artificially narrow view of retaliation. A retaliation claim does not require termination, demotion, or loss of pay. Under <em>Burlington Northern &amp; Santa Fe Ry. Co. v. White</em>, 548 U.S. 53 (2006), a materially adverse action in the retaliation context is one that could dissuade a reasonable worker from making or supporting a charge of discrimination. The facts here meet that standard.</p>
        ...
        <p className="mt-3"><strong>Respondent states that I remained employed, continued performing, and kept my compensation and responsibilities.</strong> That does not defeat retaliation. An employee can be retaliated against while still employed. An employee can be retaliated against through schedule restrictions, blocked internal movement, rating consequences, project exclusion, increased scrutiny, record manipulation, monitoring, or denial of support. Respondent's "she remained employed" argument does not answer the actual adverse actions in the record.</p>
        ...
        <p className="mt-3"><strong>Respondent states that I continued to be encouraged to apply for internal opportunities.</strong> That does not rebut retaliation. Encouraging me to apply while blocking or failing to select me is not proof of non-retaliation. I applied for nearly 50 internal roles from approximately February 2023 through April 2025. Respondent has not produced the selected candidates, recruiter notes, interview scoring, decisionmaker names, comparative qualifications, or communications. Respondent's statement that I remained free to apply does not explain why I was not selected, why projects were withheld, why my rating dropped, or why development opportunities were unavailable.</p>
        ...
        <p className="mt-3"><strong>Respondent argues that the hostile work environment claim fails because the conduct was not severe or pervasive and was not based on race.</strong> That argument misstates the record.</p>
        ...
        <p className="mt-3">Under <em>Harris v. Forklift Sys., Inc.</em>, 510 U.S. 17 (1993), the hostile work environment analysis considers the totality of the circumstances, including frequency, severity, humiliation, and interference with work performance. Under <em>Nat'l R.R. Passenger Corp. v. Morgan</em>, 536 U.S. 101 (2002), a hostile environment claim is based on the cumulative effect of individual acts. Respondent cannot defeat the claim by isolating each event and labeling it ordinary.</p>
        ...
        <p className="mt-3"><strong>Respondent also dismisses the HBCU comment as isolated and disconnected.</strong> It was not disconnected. Allan discussed HBCU recruiting during a broader August 2025 conversation about lack of advancement, lack of projects, blocked opportunity, schedule restrictions, and my inability to move forward in the organization. During that same conversation, Allan made the "blockade" statement, telling me in substance that there was a blockade and that he did not believe I could get past it. Respondent's statement that Allan had no formal recruiting role does not answer whether he made the statement or why he made it during a conversation about blocked opportunity.</p>
        <p className="mt-3"><strong>Respondent also argues that system recording, chat deletion, and leave processing are not tied to race.</strong> That is too narrow. These events occurred after repeated protected complaints about race discrimination, retaliation, schedule equity, and HR handling. They are part of the same course of conduct and may be considered as part of the total environment and retaliatory context. The issue is not whether each event used racial language. The issue is whether the total environment became hostile after I raised race discrimination and retaliation concerns.</p>
        ...
        <p className="mt-3"><strong>Respondent also argues that none of these events would constitute an adverse employment action.</strong> That is too narrow, especially for retaliation. Under <em>Burlington Northern</em>, a retaliation claim can include actions that might dissuade a reasonable worker from making or supporting a charge of discrimination. Targeted or unequal monitoring, deletion or disappearance of relevant protected-activity communications, leave-processing errors causing access deactivation, and delayed hardship assistance during a housing crisis are not trivial. They are materially relevant to retaliation, pretext, hostile environment, and credibility.</p>
