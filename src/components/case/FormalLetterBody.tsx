  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10 sm:py-14">
      ...
      <article className="rounded-md border border-border bg-card px-8 py-10 font-serif text-[14px] leading-[1.7] text-foreground/90 sm:px-12 sm:py-14 print:border-0 print:px-0 print:py-0 print:shadow-none">
        ...
        <p className="mt-3"><strong>Respondent argues that I cannot establish race discrimination because I supposedly did not suffer a materially adverse employment action.</strong> That is incorrect.</p>
        ...
        <p className="mt-3"><strong>Respondent cannot defeat this issue by saying I remained employed, kept my pay, or received strong evaluations.</strong> Under Title VII, an employee does not have to show termination, demotion, or loss of pay to show harm. Schedule, assignments, access to opportunity, visibility, and working conditions can be terms or conditions of employment. Here, the record shows harm to my schedule, advancement path, project access, performance rating, and career mobility.</p>
        <p className="mt-3"><strong>Respondent also states that I received strong evaluations.</strong> That is incomplete. Before my protected activity, I received a 2023 overall rating of Strong. In the first review cycle after my May 2024 EEOC charge and May 29, 2024 formal internal complaint, my overall rating dropped to Solid. That downgrade occurred despite strong underlying metrics, no goal rated below Solid, and a 124.36% bonus payout. My rating later returned to Strong in 2025. The issue is the Strong → Solid → Strong pattern and the timing of the 2024 downgrade.</p>
        ...
        <p className="mt-3"><strong>Respondent also attempts to dismiss the hardship-fund and HBCU comments as isolated and disconnected.</strong> They are not disconnected. The hardship-fund evidence shows different treatment in the same general process. Shortly before the July 10, 2025 incident, I personally assisted Brandi Cordi, a White employee on my team, with a hardship-fund request. Brandi was not required to submit supporting documentation. She only had to identify what she needed assistance for and provide a list or explanation of the requested need. Allan was aware of and assisted with that request. No concern was raised.</p>
